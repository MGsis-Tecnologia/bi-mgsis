...
// Rotas acessíveis sem sessão. "/", "/register" e "/master/bootstrap" já se
// autoprotegem por regra de negócio própria (só funcionam com 0 registros);
// "/ativar" se autoprotege pelo próprio token de convite (single-use, expira).
// Aqui só precisam ficar fora do bloqueio genérico de sessão.
const PUBLIC_EXACT = new Set(["/", "/login", "/register", "/health", "/master/bootstrap", "/ativar"]);
